module.exports = (mediator, answer, common) => {
    ...
    return async (req, res) => {
        const { guid, name, price, brandId, genderId, typeId, sizeIds, colorIds, stockQuantity, description, image } = req.body;
        ...
        const response = await mediator.call(CREATE_PRODUCT, { 
            guid, name, price, brandId, genderId, typeId, sizeIds, colorIds, stockQuantity, description, image 
        });
        res.json(response);
    };
};